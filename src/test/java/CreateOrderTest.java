...
public class CreateOrderTest extends AbstractTestWithUser {
    ...
    @Description("Создание заказа с авторизацией  и невалидными ингредиентами\n" +
            "запрос возвращает правильный код ответа\n" +
            "успешный запрос возвращает success: false")
    ...
    @Test
    @DisplayName("Создание заказа с без авторизации и с ингредиентами")
    @Description("Создание заказа с без авторизации и с ингредиентами\n" +
            "запрос возвращает правильный код ответа\n" +
            "успешный запрос возвращает success: false")
